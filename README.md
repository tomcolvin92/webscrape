...
- Article 6 CARP authorizations table from the [CARP authorizations page](https://unfccc.int/process-and-meetings/the-paris-agreement/article-6/article-62/carp/authorizations), including party, authorization details, and extracted document URL columns.
...
Run the CARP scraper to print the first few rows of the authorizations table:
